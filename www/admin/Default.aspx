    ...
    <form id="form1" runat="server">
        ...
        <div class="login-card">
            ...
            <div>
                ...
                <asp:TextBox runat="server" ID="tbPassword" placeholder="Password" TextMode="Password"></asp:TextBox>
                ...
                <asp:Button runat="server" ID="btLogin" CssClass="login login-submit" Text="Login" OnClick="btLogin_Click" ValidationGroup="vgA" />
            </div>
        </div>
    </form>
